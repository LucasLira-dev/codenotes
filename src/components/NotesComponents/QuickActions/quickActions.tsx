    ...
    return (
      <Card className="flex flex-col justify-between bg-[var(--card)] border-[var(--border)] shadow-md w-full sm:max-w-md">
        ...
        <CardContent className="flex flex-col lg:flex-row items-center justify-center p-4 gap-2">
          <Link 
          href="/editor" 
          className="bg-[var(--primary)] rounded-md flex flex-row items-center justify-center p-3 gap-2 mb-2 w-full hover:brightness-90 cursor-pointer">
            <Plus />
          ...
          <Link 
          href="/editor" 
          className="bg-[var(--background)] border-1 border-[var(--border)] text-[var(--foreground)] hover:brightness-90 p-3 gap-2 mb-2 rounded-md flex flex-row items-center justify-center w-full cursor-pointer">
            <Code2 />
